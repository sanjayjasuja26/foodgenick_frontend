...
const Index = () => {
  ...
  return (
    <div className="">
      ...
      <h2 className="text-login font-montserrate xl:text-6xl lg:text-5xl md:text-4xl font-bold text-dark lg:mb-20 md:mb-10 text-center z-10 relative lg:before:content-[attr(before)] before:absolute before:bg-signup xl:before:h-52 xl:before:w-96 lg:before:h-52 md:before:h-20 lg:before:w-56 md:before:w-56 before:w-64 before:h-12 md:before:w-72 before:bg-10% before:bg-no-repeat xl:before:-top-14 before:-top-4 lg:before:-top-6 md:before:-top-3 before:-left-2.5 before:right-0 before:left-0 before:mx-auto before:-z-10 text-4xl mb-8"><span className="text-yellow">Sign</span>up</h2>
