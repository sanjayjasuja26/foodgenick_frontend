...
const [activeTab, setActiveTab] = useState('profile');
  ...
  return (
    <>
      ...
      { HomeData && HomeData.length > 0 && HomeData.map((ele,index)=>{
                ...
                <h2 className='font-poppins text-lg lg:text-6xl font-bold text-dark lg:mb-6 md:mb-6 p-1'>Contact</h2>
                  ...
                  <ul>
                    <li className='font-montserrate text-sm md:text-base	font-semibold	text-black100 mb-1.5 hover:text-yellow p-1'>
                      ...
                      />
                      <Link href='tel:91 81468-02482' className='ease-in duration-300'>+91 7814606432</Link></li>
                    <li className='font-montserrate text-sm md:text-base	font-semibold	text-black100 mb-1.5 hover:text-yellow p-1'>
                      <Image
                        alt="mail"
                        src={mail}
                        className='inline-block mr-3.5'
                      />
                      <Link href='mailto:support@foodgienic.com' className='ease-in duration-300'>support@foodgienic.com</Link></li>
                      ...
                      <Image
                        ...
                        className='inline-block mr-3.5'
                      />
                      <Link href='/terms' className='ease-in duration-300'>Terms & Conditions</Link></li>
                      ...
                      <Image
                        ...
                        className='inline-block mr-3.5'
                      />
                      <Link href='/policy' className='ease-in duration-300'>Privacy Policy</Link></li>
                    ...
                    <li className='font-montserrate text-sm md:text-base flex items-start font-semibold	text-black100 mb-1.5 xl:max-w-md hover:text-yellow p-1'>
                      ...
                      />
                      <Link href='https://goo.gl/maps/WUpd8uPosEpQJuY76' className='ease-in duration-300 w-11/12	' target="_blank">#161, Second Floor, Sector 124, Sunny Enclave Extension, kharar, SAS Nagar, Punjab-140301</Link></li>
                  </ul>

                  <ul className='flex mt-8'>
                    <li className='mr-2.5	bg-white w-12 h-12 rounded-lg	drop-shadow-sm hover:bg-yellow ease-in duration-500'><Link href="/" target="_blank" className="flex	items-center justify-center h-full w-full"><Image
                      alt="facebook"
                      src={fb}
                    />
                    </Link></li>
          ...
          <div className='lg:max-w-xxxl md:max-w-xxxl mx-auto  md:pl-7 pl-2 md:pr-7 pr-2'>
            <div className="mb-4">
              <ul className="flex flex-wrap -mb-px text-sm font-medium text-center" role="tablist">
                <li className={`${activeTab === 'profile' ? 'border-b-2 border-orange text-orange' : ''} md:w-30% w-full text-2xl  border-b-2`} role="presentation">
                  <button
                ...
                <li className={`${activeTab === 'dashboard' ? 'border-b-2 border-orange text-orange' : ''} md:w-30% w-full text-2xl  border-b-2`} role="presentation">
                  <button
                    className="inline-block p-4 rounded-t-lg focus:outline-none"
                    id="dashboard-tab"
                    type="button"
                ...
                <li className={`${activeTab === 'settings' ? 'border-b-2 border-orange text-orange' : ''} md:w-30% w-full text-2xl  border-b-2`} role="presentation">
                  <button
                    className="inline-block p-4 rounded-t-lg focus:outline-none"
                    id="settings-tab"
                    type="button"
          ...
          <div className='lg:max-w-xxxl md:max-w-xxxl mx-auto  md:pl-7 pl-2 md:pr-7 pr-2'>
            <div className='flex justify-between	flex-wrap	'>
              <div className='md:w-1/4 w-full	md:mb-0 mb-4'>
                <h2 className='text-2xl	font-bold pb-3 relative'>Business Types</h2>
                <span className="block w-9	border-b-2 border-orange mb-5 after:block after:border-b-2 after:border-orange"></span>

                <ul>
                  <li className='text-base mb-1'><a href="#" className='ease-in duration-500 hover:text-orange'>Electronics & Mobiles</a></li>
                  <li className='text-base mb-1'><a href="#" className='ease-in duration-500 hover:text-orange'>Lifestyle</a></li>
                  <li className='text-base mb-1'><a href="#" className='ease-in duration-500 hover:text-orange'>Automobile</a></li>
                  <li className='text-base mb-1'><a href="#" className='ease-in duration-500 hover:text-orange'>Grocery</a></li>
                  <li className='text-base mb-1'><a href="#" className='ease-in duration-500 hover:text-orange'>Healthcare</a></li>
                  <li className='text-base mb-1'><a href="#" className='ease-in duration-500 hover:text-orange'>Hospitality</a></li>
                </ul>
              </div>
              <div className='md:w-1/4 w-full	md:mb-0 mb-4'>
                <h2 className='text-2xl	font-bold pb-3 relative'>Payments Instore</h2>
                <span className="block w-9	border-b-2 border-orange mb-5 after:block after:border-b-2 after:border-orange"></span>

                <ul>
                  <li className='text-base mb-1'><a href="#" className='ease-in duration-500 hover:text-orange'>Plutus Smart</a></li>
                  <li className='text-base mb-1'><a href="#" className='ease-in duration-500 hover:text-orange'>Plutus PoS</a></li>
                  <li className='text-base mb-1'><a href="#" className='ease-in duration-500 hover:text-orange'>Plutus QR</a></li>
                  <li className='text-base mb-1'><a href="#" className='ease-in duration-500 hover:text-orange'>Palm</a></li>
                  <li className='text-base mb-1'><a href="#" className='ease-in duration-500 hover:text-orange'>AllTap</a></li>
                  <li className='text-base mb-1'><a href="#" className='ease-in duration-500 hover:text-orange'>Hub</a></li>
                </ul>
              </div>
              <div className='md:w-1/4 w-full md:mb-0 mb-4'>
                <h2 className='text-2xl	font-bold pb-3 relative'>Business Types</h2>
            ...
            <div className='border-t mt-6 pt-6 flex justify-between items-center flex-wrap'>
              <div className='md:w-1/2	'>
                <ul className='flex items-center flex-wrap md:text-xs text-0'>
                  <li className='text-sm pr-2.5  md:w-auto w-full md:mb-0 mb-3'><a href="#" className='ease-in duration-500 hover:text-orange'>Privacy Policy</a></li>|
                  <li className='text-sm md:pr-2.5 md:pl-2.5  md:w-auto w-full md:mb-0 mb-3'><a href="#" className='ease-in duration-500 hover:text-orange'>Terms of Use</a></li>|
                  <li className='text-sm md:pr-2.5 md:pl-2.5  md:w-auto w-full md:mb-0 mb-3'><a href="#" className='ease-in duration-500 hover:text-orange'>Refund Policy</a></li>|
                  <li className='text-sm md:pl-2.5  md:w-auto w-full md:mb-0 mb-3'><a href="#" className='ease-in duration-500 hover:text-orange'>Vulnerability Disclosure Policy</a></li>
                </ul>

              </div>
              <div className='md:w-1/2	md:mt-0 mt-4'>
                  <ul className='flex justify-end	'>
                    <li className='mr-2.5	bg-white w-12 h-12 rounded-lg	drop-shadow-sm hover:bg-yellow ease-in duration-500 border'><Link href="/" target="_blank" className="flex	items-center justify-center h-full w-full"><Image
                      alt="facebook"
                      src={fb}
                    />
                    </Link></li>
            ...
            <div className='flex items-center justify-start	mt-2 flex-wrap' >
                <Image src={ flogo1} alt="logo" className='md:w-36 w-46% md:mr-3 md:mt-0 mt-5'  />
                <Image src={ flogo2}  alt="logo" className='md:w-36 w-46% md:mr-3 md:mt-0 mt-5'/>
               <Image src={ flogo3} alt="logo" className='md:w-36	w-46% md:mr-3 md:mt-0 mt-5'/>
               <Image src={ flogo4} alt="logo" className='md:w-36	w-46% md:mr-3 md:mt-0 mt-5'/>
