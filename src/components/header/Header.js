                ...
                <div className='lg:hidden' onClick={menuToggle}>
                  ...
                  <div className='lg:w-auto w-full'>
                      <ul className='flex items-center justify-between flex-wrap'>
                        <li className='font-montserrate md:text-base	text-sm	font-semibold lg:px-3.5 py-2.5	px-5 lg:px-3 lg:w-auto w-full lg:border-0	 lg:border-transparent border-b border-slate-300'><Link href="/" className={`${path === "/" ? activeClass : "" } text-dark hover:text-yellow active:text-yellow ease-in duration-500 block`}>Home</Link></li>
                        <li className='font-montserrate md:text-base	text-sm	font-semibold lg:px-3.5 py-2.5	px-5 lg:px-3 lg:w-auto w-full lg:border-0	 lg:border-transparent border-b border-slate-300'><Link href="/../main/services" className={`${path === "/main/services" ? activeClass : "" } text-dark hover:text-yellow ease-in duration-300 block`}>Our Services</Link></li>
                        <li className='font-montserrate md:text-base	text-sm	font-semibold lg:px-3.5 py-2.5	px-5 lg:px-3 lg:w-auto w-full lg:border-0	 lg:border-transparent border-b border-slate-300'><Link href="/../main/about" className={`${path === "/main/about" ? activeClass : "" } text-dark hover:text-yellow ease-in duration-300 block`}>About</Link></li>
                        {userType === '3' || userType === '1'  ? <li className='font-montserrate md:text-base	text-sm	font-semibold lg:px-3.5 py-2.5	px-5 lg:px-3 lg:w-auto w-full lg:border-0	 lg:border-transparent border-b border-slate-300'><Link href="/../main/pricing" className={`${path === "/main/pricing" ? activeClass : "" } text-dark hover:text-yellow ease-in duration-300 block`}>Pricing</Link></li> : null}
                        <li className='font-montserrate md:text-base	text-sm	font-semibold lg:px-3.5 py-2.5	px-5 lg:px-3 lg:w-auto w-full lg:border-0	 lg:border-transparent border-b border-slate-300'><Link href="/../main/blog" className={`${path === "/main/blog" ? activeClass : "" } text-dark hover:text-yellow ease-in duration-300 block`}>Blog</Link></li>
                      </ul>
                    </div>
                    {cookie && cookie != undefined ?
                    <div>
                    ...
                    <div className='lg:w-auto w-full lg:mt-0 mt-5'>
                      <ul className='flex'>
                        <li className='group font-montserrate text-sm	font-semibold border border-black	flex items-center rounded-lg ease-in duration-500 bg-white hover:bg-yellow hover:text-white hover:border-yellow mr-2.5'><Link href="/login" className='lg:px-7 md:py-3 py-2 md:px-5	px-3'>Login
                        ...
                        <li className='group font-montserrate text-sm	font-semibold border border-black	 flex items-center rounded-lg ease-in duration-500 bg-white hover:bg-yellow hover:text-white hover:border-yellow'><Link href="/signup" className='lg:px-7 md:py-3 py-2 md:px-5 px-3'>Sign Up 
