                    ...
                    <div className="">
                        ...
                        <section className='lg:pb-0 relative'>
                                <div className='relative'>
                                    <h2 className="font-montserrate text-2xl font-bold text-dark z-10 relative mb-3 border-b pb-2.5 ">Delete Restaurant</h2>
                                    <div className='py-7 xl:max-w-5xl xl:mx-auto lg:p-8 rounded-lg border-black mt-4 md:py-9 relative z-10'>
                                        <section className='lg:pb-0 relative'>
                                            ...
                                            <p className="md:text-lg text-base font-montserrate text-lightgrey mb-5 flex justify-center text-center">Do you really want to delete this data?</p>
